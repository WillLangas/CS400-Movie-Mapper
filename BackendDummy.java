...
public class BackendDummy implements BackendInterface {
    ...
    public List<String> getAvgRatings() {
        ...
        return Arrays.asList(new String [] { "8", "10", "5" });
    }
    ...
    public List<MovieInterface> getThreeMovies(int startingIndex) {
        ...
        movies.add(new MovieInterface() {
            ...
            @Override
            public List<String> getGenres() {
                return Arrays.asList(new String[] { "Action", "Thriller" });
            }
            ...
            @Override
            public String getDescription() {
                return "A detective goes to an insane asylum on an island to investigate an escaped patient.";
            }
        ...
        movies.add(new MovieInterface() {
            ...
            @Override
            public String getDescription() {
                return "The Looney Tunes cast must defeat a team of galatic monsters with the help of NBA star Micheal Jordan.";
            }
